...
print(3*num1)   # hello! hello! hello!
...
print(num1.isalnum()) # checks if string contain alpha-numeric
print(num1.isascii())
print(num2.endswith('i'))
print(num1.count('l')) # return count of occarence of same character or substring
...
print(num1.join('si')) #insert the string between s and i
